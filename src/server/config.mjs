...
export default function makeConfig()
{
  ...
  return Object.freeze( {
    ...
    KYOTO_HTML: {
      HTML_URI: 'https://www.pref.kyoto.jp/kentai/corona/hassei-bn.html',
      LICENSE: license.FREE
    },  // URIをスクレイピングで探してデータを拾う
    NARA_XLS: {
    ...
    HIROSHIMA_CSV: {
      ...
      DATA_URI: 'https://www.pref.hiroshima.lg.jp/soshiki_file/brand/covid19/opendata/340006_hiroshima_covid19_01_patients.csv',
      LICENSE: license.CC
    },
    OKAYAMA_CSV: {
      ...
      DATA_URI: 'http://www.okayama-opendata.jp/ckan/dataset/e6b3c1d2-2f1f-4735-b36e-e45d36d94761/resource/d021c012-297e-4ea9-bffa-cf55741884d1/download/kansenshashousaijouhou0420.csv',
